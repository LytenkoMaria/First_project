         ...
         <lable class="home">Comments</lable>
            ...
            <div class="comments-place">  
                    ...
                    <div class="media" id="media">
                          ...
                          <div class="new-bar"> 
                               <?php
                               //mail('workproject3006@gmail.com', 'ffff', 'dddd', 'From: workproject3006@gmail.com');
                                    ...
                                    $stm->execute();
                                      ...
                                      while($row = $stm->fetch(PDO::FETCH_ASSOC))
                                        ...
                                        if($parent_comments==0){
                                                               ...
                                                               echo "<form method='post' class='create-reply-comments reply-comments' data-id='$id_comments'><input name='parent_id' type='hidden' value='$id_comments'>S
                                                                     </form>";
