...
<body>
            ...
            <div class="menu">
                   <ul class="list-navigation">
                        ...
                        <li class="nav-item"><a href="#" class="nav-link">Coment</a></li>
      ...
      <div  class="home-page" >
           ...
           <?php   /*if(!isset($_SESSION["image"])){
                           <script> document.getElementById("sign-in-form").src=$_SESSION["image"]; </script>
                         } */?>

                 <lable class="home">Coments</lable>
                 <img src="./resources/images/Picture.png" class="home-img">
                 
                 <button  type="submit" name="submit" class=" home sign-in btn btn-primary"><strong>Coment</strong></button>
